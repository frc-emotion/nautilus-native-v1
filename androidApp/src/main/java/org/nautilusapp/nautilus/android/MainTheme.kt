...
fun MainTheme(
    ...
    //use dynamic colors on android 12+, else use fallback color schemes
    ...
    val colors = when (preference) {
        ColorTheme.NAUTILUS_DARK -> nautilusMidnight
...
//    val dynamicColorAvailable = Build.VERSION.SDK_INT >= Build.VERSION_CODES.S
    ...
    val defaultDark = DarkColors
    val defaultLight = LightColors
